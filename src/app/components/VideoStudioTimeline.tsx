...
export default function VideoStudioTimeline() {
  ...
  return (
    <div className="w-full bg-slate-900 rounded-xl overflow-hidden border border-slate-800 text-slate-200">
      ...
      <div className="px-3 py-2 bg-slate-950/80 border-b border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded bg-[#C8102E] hover:bg-[#b00e27] text-white font-medium flex items-center gap-1.5 text-[10px] sm:text-[11px] transition-colors cursor-pointer active:scale-95"
          >
            {isPlaying ? (
              <>
      ...
      {/* Timeline Tracks View (Scrollable on mobile) */}
      <div className="overflow-x-auto scrollbar-hide touch-pan-x">
        <div className="p-3 bg-slate-950/40 space-y-1.5 relative overflow-hidden select-none min-w-[340px] sm:min-w-full">
          {/* Playhead Indicator */}
          <div
          ...
          <div className="flex items-center gap-2">
            <div className="w-12 sm:w-14 shrink-0 text-[9px] font-mono text-slate-400 flex items-center gap-1">
            ...
            <div className="flex-1 h-6 bg-slate-950/60 rounded p-0.5 flex gap-1 relative border border-slate-800/60 overflow-hidden">
              <div className="w-full h-full rounded bg-emerald-950/50 border border-emerald-800/50 flex items-center justify-between px-2 text-[9px] text-emerald-300">
                <span className="font-mono text-[9px] truncate">
                  🔊 Audio Master (EQ, Drops & Voiceover)
                </span>
                <div className="flex items-center gap-0.5 h-2.5 shrink-0 ml-1">
