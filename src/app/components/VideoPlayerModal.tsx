...
export default function VideoPlayerModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[96vh] sm:max-h-[90vh] animate-fade-in-up"
      ...
      >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            {project.videoUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1 px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-[10px] sm:text-[11px] text-slate-300 hover:text-white transition-colors"
              >
                <span>Source</span>
        ...
        {/* Footer Details */}
        <div className="p-3 sm:p-4 bg-slate-950/80 border-t border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
